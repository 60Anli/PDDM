...
parser = argparse.ArgumentParser(description="Run PDDM forecasting on electricity for all horizons.")
parser.add_argument("--config", type=str, default="base_forecasting.yaml")
parser.add_argument("--device", type=str, default="cuda:0")
parser.add_argument("--root_path", type=str, default="./data/electricity")
